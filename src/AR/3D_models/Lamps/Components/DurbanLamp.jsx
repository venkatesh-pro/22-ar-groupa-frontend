...
export function DurbanLamp(props) {
  const { nodes, materials } = useGLTF(
    "assets/Lamps/durban_lamp/scene-transformed.glb"
  );
  return (
    <group
      {...props}
      ...
      <group rotation={[-Math.PI / 2, 0, 0]}>
        ...
        >
          <group position={[0, -0.03, -137.48]}>
            ...
            />
            <mesh
              geometry={nodes.STEEL_MATT_GREY.geometry}
              material={materials.STEEL_MATT_GREY}
            />
            <mesh
